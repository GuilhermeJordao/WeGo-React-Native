...
const BMW = ({navigation}) => {
    return (
        ...
        <Text style={{fontSize:15,fontFamily:'Roboto-Medium',color: '#000000',fontWeight: "bold",marginTop:25}}>Eletroposto Autostar BMW</Text>  
        <TouchableOpacity>
        <Ionicons name="heart-circle-outline" color='#FF0000' size={30} style={{marginLeft:10,marginTop:20}} />
        </TouchableOpacity>
        </View>
        <View>
        <Image source={require('../assets/imagesPosto/EletricoBMW.png')} style={{width:"100%",height:300,borderRadius: 40}} />
        </View>
