...
const AutoPostoMorada = ({navigation}) => {
    return (
        <SafeAreaView style={{flex:1,backgroundColor:'#272727'}}>
        <ScrollView>
        <View style={styles.Title}>
        <Text style={{fontSize:15,fontFamily:'Roboto-Medium',color: '#000000',fontWeight: "bold",marginTop:25}}>Auto Posto Morada do Sol</Text>  
        <TouchableOpacity>
        <Ionicons name="heart-circle-outline" color='#FF0000' size={30} style={{marginLeft:10,marginTop:20}} />
        </TouchableOpacity>
        </View>
        <View>
        <Image source={require('../assets/imagesPosto/MoradadoSol.png')} style={{width:"100%",height:300,borderRadius: 40}} />
        </View>
        ...
        <View
            ...
            <Text style={styles.PrecosGas}>R$ 4.899</Text>
            </View>
            <View style={{flexDirection: 'row',marginTop: 20}}>
            ...
            <Text style={styles.PrecosGas}>R$ 5.899</Text>
            </View>
...
export default AutoPostoMorada;
