...
const ServicoBand = ({navigation}) => {
    return (
        <SafeAreaView style={{flex:1,backgroundColor:'#272727'}}>
        <ScrollView>
        <View style={styles.Title}>
        <Text style={{fontSize:15,fontFamily:'Roboto-Medium',color: '#000000',fontWeight: "bold",marginTop:25}}>Posto Serviço Bandeira</Text>  
        <TouchableOpacity>
        <Ionicons name="heart-circle-outline" color='#FF0000' size={30} style={{marginLeft:10,marginTop:20}} />
        </TouchableOpacity>
        </View>
        <View>
        <Image source={require('../assets/imagesPosto/BandeiraServicos.png')} style={{width:"100%",height:300,borderRadius: 40}} />
        </View>
        <View style={{backgroundColor:'#ff8c00'}}>
        </View>
        <View style={styles.List}> 
        <View style={styles.Endereco}>
        <Text style={{fontSize:14,fontFamily:'Roboto-Medium',color: '#203354',fontWeight: "bold",marginTop:10,marginLeft:5,marginLeft:10}}>Endereço: Av. São Miguel, 3785 - Pte. Rasa, São Paulo - SP, 03871-000</Text>  
        <View
            style={{
            ...
            <Text style={styles.PrecosGas}>R$ 5.797</Text>  
            </View>
            <View style={{flexDirection: 'row',marginTop: 20}}>
            ...
            <Text style={styles.PrecosGas}>R$ 5.997</Text>
            </View>
            <View style={{flexDirection: 'row',marginTop: 20}}>
